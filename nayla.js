...
break
case 'daftar':
if (cekUser("id", sender) !== null) return reply("𝗸𝗮𝗺𝘂 𝘀𝘂𝗱𝗮𝗵 𝘁𝗲𝗿𝗱𝗮𝗳𝘁𝗮𝗿 𝘀𝗲𝗯𝗲𝗹𝘂𝗺 𝗻𝘆𝗮:𝟯 𝗴𝘂𝗻𝗮𝗸𝗮𝗻 𝗰𝗼𝗺𝗺𝗮𝗻𝗱 #𝗺𝗲𝗻𝘂 𝘂𝗻𝘁𝘂𝗸 𝗺𝗲𝗻𝗴𝗲𝘁𝗮𝗵𝘂𝗶 𝗮𝗽𝗮 𝘀𝗮𝗷𝗮 𝗳𝘂𝗻𝗴𝘀𝗶 𝗯𝗼𝘁 𝗶𝗻𝗶")
daftar.push({id: sender, emote:"🫠", ban:false, game: false, jawaban:false, hit:1, broadcast: false, koin:0})
fs.writeFileSync('./db/function/daftar.json', JSON.stringify(daftar))
reply(`[ *𝗦𝗨𝗞𝗦𝗘𝗦 𝗧𝗘𝗥𝗗𝗔𝗙𝗧𝗔𝗥* ] 
• *𝗬𝗢𝗨𝗥 𝗡𝗔𝗠𝗘* : ${m.messages[0].pushName}
• *𝗦𝗘𝗡𝗗𝗘𝗥* : ${sender.split("@")[0]} 
• *𝗜𝗦 𝗚𝗥𝗢𝗨𝗣* : ${m.messages[0].isGroup}`)
break

case 'owner':
if (cekUser("id", sender) == null) return reply("𝗸𝗮𝗺𝘂 𝗯𝗲𝗹𝘂𝗺 𝘁𝗲𝗿𝗱𝗮𝗳𝘁𝗮𝗿 𝗱𝗶 𝗱𝗮𝘁𝗮𝗯𝗮𝘀𝗲 𝗯𝗼𝘁, 𝘀𝗶𝗹𝗮𝗵𝗸𝗮𝗻 𝗱𝗮𝗳𝘁𝗮𝗿 𝘁𝗲𝗿𝗹𝗲𝗯𝗶𝗵 𝗱𝗮𝗵𝘂𝗹𝘂, 𝗴𝘂𝗻𝗮𝗸𝗮𝗻 𝗰𝗼𝗺𝗺𝗮𝗻𝗱 #𝗱𝗮𝗳𝘁𝗮𝗿")
let [x2] = ownerNumber
...
if (budy == prefix + "sc"){reply("Lu Nyari Sc? Cek Aja Di Yt Sayang")} // JANGAN DI UBAH:(
}} catch (err) {
